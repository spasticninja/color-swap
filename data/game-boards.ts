...
export const gameBoardsBase: tGameBoardBase[] = [{
  ...
  slug: 'complex-personality',
  colors: ['#594157', '#eadbbd', '#89c678', '#40bb94'],
  width: 9,
  height: 10
}, {
  name: 'All her stories',
  slug: 'all-her-stories',
  colors: ['#FFB345', '#FF705E', '#FF406F', '#283A63'],
  width: 9,
  height: 10
}, {
  name: 'Love the effort',
  slug: 'love-the-effort',
  colors: ['#a31a68', '#f4d3a7', '#08156b', '#02a1d1'],
  width: 9,
  height: 10
}, {
  name: 'Feast your heart',
  slug: 'feast-your-heart',
  colors: ['#E15D47', '#FFD46B', '#55ADFF', '#604B8A'],
  width: 9,
  height: 10
}, {
  name: 'Bind me',
  slug: 'bind-me',
  colors: ['#7DC6C5', '#035AA6', '#F4A548', '#862A5C'],
  width: 9,
  height: 10
}, {
  name: 'Uncommon fear',
  slug: 'uncommon-fear',
  colors: ['#CB666A', '#D9C5A9', '#82817F', '#1D5577'],
  width: 9,
  height: 10
}, {
  name: 'So many days',
  slug: 'so-many-days',
  colors: ['#4b1e85', '#6fae9d', '#ffcf9d', '#50a9e1'],
  width: 9,
  height: 10
}, {
  name: 'Summer Dream',
  slug: 'summer-dream',
  colors: ['#4ECDC4', '#F7FFF7', '#FF6B6B', '#FFE66D'],
  width: 9,
  height: 10
}, {
  name: 'Fauvist artwork',
  slug: 'fauvist-artwork',
  colors: ['#47282D', '#929148', '#C3A871', '#EAE8D1'],
  width: 9,
  height: 10
}, {
  name: 'Arizona Sunset',
  slug: 'arizona-sunset',
  colors: ['#920F1F', '#E4825B','#96979D','#30384E'],
  width: 9,
  height: 10
}, {
  name: '90s Pastels',
  slug: '90s-pastels',
  colors: ['#e8ffb2', '#f46e77', '#894fff', '#22c132'],
  width: 9,
  height: 10
}, {
  name: 'Pool time chill',
  slug: 'pool-time-chill',
  colors: ['#6dcfe0', '#fcc2ea', '#edf9a9', '#3d22d8'],
  width: 9,
  height: 10
}, {
  name: 'Candy Dreams 1',
  slug: 'candy-dreams-1',
  colors: ['#cc045a', '#94a2fc', '#d2f993', '#ed95a1'],
  width: 9,
  height: 10
}, {
  name: 'Candy Dreams 2',
  slug: 'candy-dreams-2',
  colors: ['#cc045a', '#f9a78e', '#94a2fc', '#d2f993'],
  width: 9,
  height: 10
}, {
  name: 'Donut Party',
  ...
  slug: 'rosettes-and-cream',
  colors: ['#D8A7B1', '#B6E2D3', '#FAE8E0', '#EF7C8E'],
  width: 9,
  height: 10
}, {
  name: 'Pastel Blonde',
  slug: 'pastel-blonde',
  colors: ['#887BB0', '#85D2D0', '#F4B9B8', '#FFF4BD'],
  width: 9,
  height: 10
}, {
  name: 'Thwarted Summer Shower',
  slug: 'thwarted-summer-shower',
  ...
  name: 'Pliant and Free',
  slug: 'pliant-and-free',
  colors: ['#FEECC0', '#F4B9B8', '#556890', '#1F2020'],
  width: 9,
  height: 10
}, {
  name: 'Candle in Twilight',
  slug: 'candle-in-twilight',
  colors: ['#f1e3d0', '#fbb550', '#dd3290', '#621590'],
  width: 9,
  height: 10
}, {
  name: 'Strawberry and Cream',
  slug: 'strawberry-and-cream',
  colors: ['#e9b1a0', '#b57170', '#dc4c60', '#a30052'],
  width: 9,
  height: 10
}];
